...
public class KawaMap {
    public Integer footerBtnBgColor = Color.BLUE;
    public Integer footerBtnTextColor = Color.WHITE;

    public Integer innerBtnBgColor = R.color.orange;
    public Integer innerBtnTextColor = Color.BLACK;

    public Integer headerBgColor = Color.WHITE;
    public Integer headerTextColor = Color.BLACK;

    public static boolean isValidKawaAPiKey;
    public static String KAWA_API_KEY = "kawa_RLkNIPN-z3TeWb8AWv089w";
    ...
    private void initSmartlook(String smartlook_api_key) {
    ...
    private void initSegment(Context context, String segment_api_key) {
...
//            segmentIntegration_from_SDK(context);
    ...
    public void setFooterBtnBgColorAndTextColor(Context context, int bgColor, int textColor) {
        footerBtnBgColor = context.getResources().getColor(bgColor);
        footerBtnTextColor = context.getResources().getColor(textColor);
    }

    public void setInnerBtnBgColorAndTextColor(Context context, int bgColor, int textColor) {
        innerBtnBgColor = bgColor;
        innerBtnTextColor = context.getResources().getColor(textColor);
    }

    public void setHeaderBgColorAndTextColor(Context context, int bgColor, int textColor) {
        headerBgColor = context.getResources().getColor(bgColor);
        headerTextColor = context.getResources().getColor(textColor);
    }

    public void setFooterButtonColor(Button[] footerButtons) {
    ...
    public void setInnerButtonColor(Context context, Button[] innerButtons) {
    ...
    public void smartlookIntegration() {
    ...
    public void segmentIntegration(Context context) {
    ...
    public boolean initKawaMap(Context context, String kawa_api_key) {
...
//        }
    ...
    public void startKawaSDK(FragmentActivity context, String kawa_api_key) {

        initKawaMap(context, kawa_api_key);
...
//        headerTextColor = context.getResources().getColor(R.color.white);
    ...
    public void exitKawaSDKAndGoToActivity(Context context, String classname) {
        try {
    ...
    public void exitKawaSDKAndGoBack(Activity activity) {
        activity.finish();
